...
enum {PAS_ADR,NO_ARGS,PAS_DECALAGE,CARAC_U,DEL_ALL,DEL_1,NON_HEXA,PAS_LOAD,HORS_CODE,POSITION_IMPOS,BP_EXISTANT,BP_EXISTE_PAS,BP_NON_EXIST,PAS_BP,PAS_INST};
